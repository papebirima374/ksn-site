...
const DOCUMENTS: DocumentItem[] = [
  {
    ...
    size: "2.0 Mo",
    description: "Les règles fondamentales du Dahira KSN, les principes d'adhésion, de cotisation, la charte de conduite et la constitution officielle.",
  ...
  },
  {
    ...
    size: "1.9 Mo",
    description: "Le document de cadrage stratégique décrivant les objectifs annuels des commissions, le plan de développement et les projets d'avenir.",
