  ...
  return (
    ...
    >
      ...
      <svg
        ...
        style={{ width: "9.5em", height: "4.5em" }}
        viewBox="0 0 150 70"
        preserveAspectRatio="none"
        aria-hidden="true"
      >
        {/* Lighter wave layer */}
        <path d="M 0,0 L 140,0 C 110,50 50,60 0,68 Z" fill="#149b74" opacity="0.35" />
        {/* Main green wave layer */}
        <path d="M 0,0 L 120,0 C 95,42 45,52 0,58 Z" fill="#0F7C55" />
        {/* Gold accent border */}
        <path d="M 0,58 C 45,52 95,42 120,0" fill="none" stroke="#D4AF37" strokeWidth="2" />
      </svg>
      ...
      >
        {/* Lighter wave layer */}
        <path d="M 0,70 L 140,70 C 110,20 50,10 0,2 Z" fill="#149b74" opacity="0.35" />
        {/* Main green wave layer */}
        <path d="M 0,70 L 120,70 C 95,28 45,18 0,12 Z" fill="#0F7C55" />
        {/* Gold accent border */}
        <path d="M 0,12 C 45,18 95,28 120,70" fill="none" stroke="#D4AF37" strokeWidth="2" />
      </svg>
      ...
      <div className="relative z-20 flex items-center justify-between px-[1.5em] pt-[1.2em] pb-[0.4em]">
      ...
      <div className="absolute left-[1.5em] right-[1.5em] top-[4.7em] bottom-[2.2em] z-20 grid grid-cols-[7.2em_1fr_6.2em] gap-[1.2em] items-center">
        
        {/* Photo Column */}
        <div
          className="relative rounded-xl overflow-hidden bg-[#EBF0ED] shadow-sm border border-[#0F7C55]/25"
          style={{ width: "7.2em", height: "8.5em" }}
        >
          {member.photo ? (
            <Image
              src={member.photo}
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-b from-white to-[#E2EBE6] text-[#0F7C55]/30">
              <span className="font-serif font-black" style={{ fontSize: "2em" }}>
                {(member.prenom?.[0] ?? "?")}
                {(member.nom?.[0] ?? "")}
              </span>
            </div>
        ...
        {/* Details Column */}
        <div className="relative flex flex-col gap-[0.55em] z-10 pl-[0.1em]">
        ...
        <div className="flex flex-col items-center z-10">
          <div
            className="bg-white p-[0.4em] rounded-[0.7em] border border-[#0f5132]/12 shadow-md flex flex-col items-center justify-center"
...
function Field({
  ...
  return (
    <div className="flex flex-col gap-[0.15em] leading-none">
      <span
        className="text-[#0F7C55]/90 font-sans font-semibold tracking-wide"
