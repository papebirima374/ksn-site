...
const TABS = [
  { id: "presentation", labelKey: "tabs.presentation", icon: <FaCircleInfo /> },
  { id: "programme", labelKey: "tabs.programme", icon: <FaListUl /> },
  { id: "direct", labelKey: "tabs.direct", icon: <FaVideo /> },
...
export default function JourneeContent() {
  ...
  return (
    <>
      ...
      {/* COMPTE A REBOURS — toujours visible */}
      <section className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 pb-12 sm:pb-16">
      ...
      <SectionTabs
        ...
        renderPanel={(id) => (
          <>
            ...
            {id === "direct" && <JourneeLiveAndTickets />}

            {id === "galerie" && <JourneeGallery />}
